...
class ChatRequest(BaseModel):
    ...
    system_prompt: Optional[str] = Field(
        default=None, description="Optional system instruction for the LLM."
    )
...
class ChatResponse(BaseModel):
    ...
    message: str = Field(
        ..., description="The textual response generated by the LLM."
    )
    model: str = Field(
        default="gpt-4o-mini",
        description="The specific OpenAI model used for completion.",
    )
    conversation_id: Optional[str] = Field(
